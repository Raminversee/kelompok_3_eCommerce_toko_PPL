...
-- Membuang data untuk tabel contoh.migrations: ~18 rows (lebih kurang)
...
-- Membuang data untuk tabel contoh.users: ~2 rows (lebih kurang)
INSERT INTO `users` (`id`, `name`, `email`, `telepon`, `alamat`, `is_admin`, `phone`, `address`, `foto`, `is_active`, `last_login_at`, `role`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(2, 'ikhsan', 'ikhsan1@gmail.com', NULL, NULL, 0, NULL, NULL, 'users/79TeoXqmjL0rRrJs5xgjRXcSLeDFlFiGxUEV3Pf6.png', 1, '2026-05-05 04:53:49', 'pelanggan', NULL, '$2y$10$k0ZOvPcM8jYIb7ppm76LAulXojhXdU8jVw8ZZKepBTHYd865/aj5a', 'kjjOnURCjFjbiP6hgJcTfZMEpE85mVZtO0jg4FPQa1g9skOOEtE39tU0SGEo', '2026-04-28 02:59:46', '2026-05-05 04:53:49'),
...
-- Membuang data untuk tabel contoh.vouchers: ~0 rows (lebih kurang)
